...
- **Support Swift** : ajout du parsing sémantique Tree-sitter, des symboles imbriqués et du graphe d'appels Swift avec une résolution sensible à la casse et fondée sur les noms.
